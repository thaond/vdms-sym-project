...
namespace VDMS.II.Entity
{
	...
	public partial class Role : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		[Column(Name = @"APPLICATIONNAME", Storage = "_ApplicationName", CanBeNull = false, DbType = "VARCHAR2(255) NOT NULL")]
		public string ApplicationName
		{
			get
			{
		...
		[Column(Name = @"ROLENAME", Storage = "_RoleName", CanBeNull = false, DbType = "VARCHAR2(255) NOT NULL")]
		public string RoleName
		{
			get
			{
