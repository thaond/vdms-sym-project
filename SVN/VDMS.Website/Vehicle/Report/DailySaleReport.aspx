<%@ Page Language="C#" MasterPageFile="~/MP/MasterPage.master" AutoEventWireup="true"
    CodeFile="DailySaleReport.aspx.cs" Inherits="Vehicle_Report_DailySaleReport"
    ...
    <div class="form" style="width: 450px">
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td align="left">
                    <asp:TextBox ID="txtFromDate" runat="server" Width="120px" meta:resourcekey="txtFromDateResource1"></asp:TextBox>
