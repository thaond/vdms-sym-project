...
// Code is generated on: 8/19/2010 2:16:38 PM
//
...
namespace VDMS.I.Linq
{
    ...
    public partial class VehicleDataContext : Devart.Data.Linq.DataContext
    {
        ...
        partial void InsertSaleOrderPaymentTransHistory(VDMS.I.Entity.SaleOrderPaymentTransHistory instance);
        partial void UpdateSaleOrderPaymentTransHistory(VDMS.I.Entity.SaleOrderPaymentTransHistory instance);
        partial void DeleteSaleOrderPaymentTransHistory(VDMS.I.Entity.SaleOrderPaymentTransHistory instance);
        ...
        public VehicleDataContext() :
            //base(@"User Id=vdms;Password=vdms;Server=vdms;Home=oraclient11g_home1;Unicode=True;Sid=vdms;Persist Security Info=True", mappingSource)
            base(VDMS.Provider.VDMSProvider.ConnectionString, mappingSource)
        {
            OnCreated();
        }
        ...
        public Devart.Data.Linq.Table<VDMS.I.Entity.SaleOrderPaymentTransHistory> SaleOrderPaymentTransHistories
        {
            get
            {
                return this.GetTable<VDMS.I.Entity.SaleOrderPaymentTransHistory>();
            }
        }
...
namespace VDMS.I.Entity
{
    ...
    public partial class SaleReturnItem : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        [Column(Name = @"CONFIRMDATE", Storage = "_Confirmdate", DbType = "DATE")]
        ...
        [Column(Name = @"RELEASEDATE", Storage = "_Releasedate", DbType = "DATE")]
    ...
    public partial class ShippingHeader : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        [Column(Name = @"SHIPPINGID", Storage = "_ShippingId", AutoSync = AutoSync.OnInsert ,CanBeNull = false, DbType = "NUMBER(10) NOT NULL", IsDbGenerated=true ,IsPrimaryKey = true)]
        public long ShippingId
        {
            get
            {
        ...
        [Column(Name = @"CREATEDBY", Storage = "_CreatedBy", CanBeNull = false, DbType = "NVARCHAR2(256) NOT NULL")]
        public string CreatedBy
        {
            get
            {
        ...
        [Column(Name = @"SHIPPINGTO", Storage = "_ShippingTo", CanBeNull = false, DbType = "NVARCHAR2(256) NOT NULL")]
    ...
    [Table(Name = @"VDMS.SALE_ORDER_PAYMENT_TRANSHIS")]
    public partial class SaleOrderPaymentTransHistory : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntityRef<SaleOrderPayment> _SaleOrderPayment;
        ...
        public SaleOrderPaymentTransHistory()
        {
            this._SaleOrderPayment = default(EntityRef<SaleOrderPayment>);
            OnCreated();
        }
        ...
        [Column(Name = @"ORDER_PAYMENT_ID", Storage = "_OrderPaymentId", CanBeNull = false, DbType = "NUMBER(10) NOT NULL")]
        public long OrderPaymentId
        {
            ...
            set
            {
                ...
                {
                    if (this._SaleOrderPayment.HasLoadedOrAssignedValue)
                    {
                        throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
                    }
        ...
        [Column(Name = @"MODIFIED_USER", Storage = "_ModifiedUser", CanBeNull = false, DbType = "NVARCHAR2(512) NOT NULL")]
        ...
        [Column(Name = @"AMOUNT", Storage = "_Amount", CanBeNull = false, DbType = "NUMBER NOT NULL")]
        ...
        [Column(Name = @"DESCRIPTION", Storage = "_Description", DbType = "NVARCHAR2(512)")]
        ...
        [Column(Name = @"ORDERID", Storage = "_Orderid", DbType = "NUMBER(10)")]
        ...
        [Association(Name = "SaleOrderPayment_SaleOrderPaymentTransHistory", Storage = "_SaleOrderPayment", ThisKey = "OrderPaymentId", IsForeignKey = true)]
        public SaleOrderPayment SaleOrderPayment
        {
            get
            {
                return this._SaleOrderPayment.Entity;
            }
            set
            {
                SaleOrderPayment previousValue = this._SaleOrderPayment.Entity;
                if ((previousValue != value) || (this._SaleOrderPayment.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging();
                    if (previousValue != null)
                    {
                        this._SaleOrderPayment.Entity = null;
                        previousValue.SaleOrderPaymentTransHistories.Remove(this);
                    }
                    this._SaleOrderPayment.Entity = value;
                    if (value != null)
                    {
                        value.SaleOrderPaymentTransHistories.Add(this);
                        this._OrderPaymentId = value.OrderPaymentId;
                    }
                    else
                    {
                        this._OrderPaymentId = default(long);
                    }
                    this.SendPropertyChanged("SaleOrderPayment");
                }
            }
        }
    ...
    public partial class SaleOrderPayment : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntitySet<SaleOrderPaymentTransHistory> _SaleOrderPaymentTransHistories;
        ...
        {
            this._SaleOrderPaymentTransHistories = new EntitySet<SaleOrderPaymentTransHistory>(new Action<SaleOrderPaymentTransHistory>(this.attach_SaleOrderPaymentTransHistories), new Action<SaleOrderPaymentTransHistory>(this.detach_SaleOrderPaymentTransHistories));
            this._OrderHeader = default(EntityRef<OrderHeader>);
            OnCreated();
        }
        ...
        [Column(Name = @"FROM_BANK", Storage = "_FromBank", DbType = "VARCHAR2(30)")]
        ...
        [Column(Name = @"FROM_ACCOUNT", Storage = "_FromAccount", DbType = "VARCHAR2(50)")]
        ...
        [Column(Name = @"TO_BANK", Storage = "_ToBank", DbType = "VARCHAR2(30)")]
        ...
        [Column(Name = @"TO_ACCOUNT", Storage = "_ToAccount", DbType = "VARCHAR2(50)")]
        ...
        [Association(Name = "SaleOrderPayment_SaleOrderPaymentTransHistory", Storage = "_SaleOrderPaymentTransHistories", OtherKey = "OrderPaymentId")]
        public EntitySet<SaleOrderPaymentTransHistory> SaleOrderPaymentTransHistories
        {
            get
            {
                return this._SaleOrderPaymentTransHistories;
            }
            set
            {
                this._SaleOrderPaymentTransHistories.Assign(value);
            }
        }
        ...
        private void attach_SaleOrderPaymentTransHistories(SaleOrderPaymentTransHistory entity)
        {
            this.SendPropertyChanging("SaleOrderPaymentTransHistories");
            entity.SaleOrderPayment = this;
        }

        private void detach_SaleOrderPaymentTransHistories(SaleOrderPaymentTransHistory entity)
        {
            this.SendPropertyChanging("SaleOrderPaymentTransHistories");
            entity.SaleOrderPayment = null;
        }
    }
}
