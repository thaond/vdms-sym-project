<%@ Page Title="Order detail report" Language="C#" MasterPageFile="~/MP/Mobile.master"
    Theme="Mobile" AutoEventWireup="true" CodeFile="RemainingOrderDetailReport.aspx.cs"
    Inherits="MPart_Report_RemainingOrderDetailReport" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
    ...
    <div class="form">
        <table>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtOrderFrom" Width="40%" runat="server" meta:resourcekey="txtOrderFromResource1"></asp:TextBox>
                    ...
                    <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator1" runat="server" ControlToValidate="txtOrderFrom" Enabled="true" InvalidValueMessage="*" ControlExtender="meeOrderFrom"></ajaxToolkit:MaskedEditValidator>
                    ~
                    <asp:TextBox ID="txtOrderTo" runat="server" Width="40%" meta:resourcekey="txtOrderToResource1"></asp:TextBox>
                    ...
                    <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator2" runat="server" ControlToValidate="txtOrderTo" Enabled="true" InvalidValueMessage="*" ControlExtender="MaskedEditExtender1"></ajaxToolkit:MaskedEditValidator>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtIssueFrom" runat="server" Width="40%" meta:resourcekey="txtIssueFromResource1"></asp:TextBox>
                    ...
                    <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator3" runat="server" ControlToValidate="txtIssueFrom" Enabled="true" InvalidValueMessage="*" ControlExtender="meeFromDate"></ajaxToolkit:MaskedEditValidator>
                    ~
                    <asp:TextBox ID="txtIssueTo" runat="server" Width="40%" meta:resourcekey="txtIssueToResource1"></asp:TextBox>
                    ...
                    <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator4" runat="server" ControlToValidate="txtIssueTo" Enabled="true" InvalidValueMessage="*" ControlExtender="MaskedEditExtender2"></ajaxToolkit:MaskedEditValidator>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnDoReport" runat="server" Text="Find" OnClick="btnDoReport_Click" Width="40%"
