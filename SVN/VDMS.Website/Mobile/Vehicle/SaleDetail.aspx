<%@ Page Language="C#" MasterPageFile="~/MP/Mobile.master" AutoEventWireup="true"
    CodeFile="SaleDetail.aspx.cs" Inherits="MVehicle_Report_SaleDetail" Title="Báo cáo Sale - Chi tiết ngày"
    Theme="Mobile" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
    ...
    <div class="form">
        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
            ...
            <tr>
                <td colspan="2" nowrap="nowrap">
                    ...
                    <vdms:WarehouseList ID="ddlBranch" runat="server" Type="V" ShowSelectAllItem="True"
                        DontAutoUseCurrentSealer="False" MergeCode="True" meta:resourcekey="ddlBranchResource2"
                        ShowEmptyItem="False" UseVIdAsValue="False">
                    </vdms:WarehouseList>
                </td>
            ...
            <tr>
                ...
                <td style="width: 100%">
                    <asp:TextBox ID="txtFromDate" runat="server" meta:resourcekey="txtRecCDateResource1"
                        Width="40%"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1"
                            runat="server" ControlToValidate="txtFromDate" ErrorMessage='Dữ liệu "Từ ngày" không được bỏ trống!'
                    ...
                    <asp:RangeValidator ID="rvFromDate" runat="server" ControlToValidate="txtFromDate"
                        ...
                        Type="Date" ValidationGroup="Search" meta:resourcekey="rvFromDateResource1" Text="*"></asp:RangeValidator>
                    <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender1" runat="server" CultureAMPMPlaceholder="AM;PM"
                     ...
                     ~ 
                    <asp:TextBox ID="txtToDate" runat="server" meta:resourcekey="txtRecCDateResource1"
                        Width="40%"></asp:TextBox><asp:RequiredFieldValidator ID="rfvFromdate" runat="server"
                            ControlToValidate="txtToDate" ErrorMessage='Dữ liệu "đến ngày" không được bỏ trống!'
            ...
            <tr>
                <td></td>
                <td>
                    <asp:Button ID="btnSearch" runat="server" OnClick="btnSearch_Click" Text="Kiểm tra" Width="40%"
                        ValidationGroup="Search" meta:resourcekey="btnSearchResource1" />
                    <%--<asp:Button ID="btnExcel" runat="server" Text="Export to Excel" ValidationGroup="Search"
        ...
        <div class="grid">
            <vdms:PageGridView AllowPaging="True" ID="gv" runat="server" AutoGenerateColumns="False"
                DataSourceID="ods" OnDataBinding="gv_DataBinding" PageSize="30" EmptyDataText="No result found."
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="SellDate" meta:resourcekey="TemplateFieldResource6">
                        <ItemTemplate>
                            <asp:Literal ID="Literal9" runat="server" Text='<%# Eval("SellDate", "{0:d}") %>'></asp:Literal>
                        </ItemTemplate>
                    </asp:TemplateField>
        ...
        <asp:ObjectDataSource ID="ods" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="ReportSellingDaily" TypeName="VDMS.Data.DAL2.InventoryDao" OnSelecting="ods_Selecting">
            <SelectParameters>
