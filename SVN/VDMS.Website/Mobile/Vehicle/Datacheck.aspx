<%@ Page Language="C#" MasterPageFile="~/MP/Mobile.master" AutoEventWireup="true"
    Theme="Mobile" CodeFile="Datacheck.aspx.cs" Inherits="MSales_Sale_Datacheck"
    Title="Kiểm tra dữ liệu khách hàng" Culture="auto" meta:resourcekey="PageResource1"
    UICulture="auto" %>
        ...
        <table cellpadding="2" border="0" cellspacing="2">
            <tr>
                ...
                <td style="width: 80%" valign="top">
                    <asp:TextBox ID="txtEngineNo" runat="server" Width="80%" meta:resourcekey="txtEngineNoResource1"
            ...
            <tr>
                ...
                <td style="" valign="top" colspan="">
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td>
                                <asp:TextBox ID="txtFromDate" runat="server" Width="90%" meta:resourcekey="txtFromDateResource1"></asp:TextBox><ajaxToolkit:MaskedEditExtender
                            ...
                            <td style="">
                             ...
                             <td style="">
                                ~ <asp:TextBox ID="txtToDate" runat="server" Width="90%" meta:resourcekey="txtToDateResource1"></asp:TextBox><ajaxToolkit:MaskedEditExtender
            ...
            <tr>
                ...
                <td style="width: 80%" valign="top">
                    <asp:TextBox ID="txtInvoiceNo" runat="server" Width="80%" meta:resourcekey="txtInvoiceNoResource1"
                        OnLoad="InitPostbackData"></asp:TextBox>
                </td>
            </tr>
            <tr runat="server" id="VMEPView">
                ...
                <td style="width: 80%" valign="top">
                    <asp:DropDownList ID="ddlArea" runat="server" Width="80%" DataSourceID="ObjectDataSourceArea"
            ...
            <tr>
                ...
                <td style="width: 100px;" colspan="3" valign="top">
                    ...
                    <vdms:DealerList ShowSelectAllItem="true" EnabledSaperateByDB="true" RemoveRootItem="true"
                        ID="ddlDealerCode" runat="server" Width="80%" />
            ...
            <tr>
                ...
                <td style="width: 80%" valign="top">
                    <asp:TextBox ID="txtIdentityNo" runat="server" Width="80%" meta:resourcekey="txtIdentityNoResource1"
                        OnLoad="InitPostbackData"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 80%" valign="top">
                    <asp:TextBox ID="txtFullname" runat="server" Width="80%" meta:resourcekey="txtFullnameResource1"
                        OnLoad="InitPostbackData"></asp:TextBox>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width: 80%" valign="top">
                    <asp:TextBox ID="txtAds" runat="server" meta:resourcekey="txtAdsResource1" Width="80%"
                        OnLoad="InitPostbackData"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 80%" valign="top">
                    <asp:TextBox ID="txtPrecinct" runat="server" meta:resourcekey="txtPrecinctResource1"
                        Width="80%" OnLoad="InitPostbackData"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="width: 86px;" align="right" valign="top">
            ...
            <tr>
                ...
                <td style="width: 80%;" align="left" valign="top">
                    <asp:Button ID="btnTest" runat="server" Text="Kiểm tra lịch sử xe" OnClick="btnTest_Click"
                        Width="80%" meta:resourcekey="btnTestResource1" />
                </td>
            </tr>
            <tr>
                <td align="right" colspan="1" style="width: 100px" valign="top">
