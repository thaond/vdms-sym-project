<%@ Page Language="C#" MasterPageFile="~/MP/MasterPage.master" AutoEventWireup="true"
    CodeFile="Detail.aspx.cs" Inherits="Sales_Inventory_Detail" Title="Kiểm tra chi tiết tồn kho"
    ...
    <div class="form" style="width: 450px">
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtModelCode" runat="server" Width="120px" meta:resourcekey="txtTypeResource1"
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtColorCode" runat="server" Width="120px" meta:resourcekey="txtColourResource1"
                        Style="text-transform: uppercase"></asp:TextBox>
                </td>
                <td>
...
<%--                <asp:TemplateField HeaderText="Chứng từ" meta:resourcekey="TemplateFieldResource3">
                ...
                <asp:TemplateField HeaderText="Chứng từ">
                    <ItemTemplate>
                        <asp:Literal ID="litVoucher" runat="server" Text='<%#Eval("HasVoucher") %>'></asp:Literal>
                    </ItemTemplate>
                </asp:TemplateField> 
            </Columns>
        </vdms:PageGridView>
