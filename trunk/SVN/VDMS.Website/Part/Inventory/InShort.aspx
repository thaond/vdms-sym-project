<%@ Page Title="In Short Query" Language="C#" MasterPageFile="~/MP/MasterPage.master"
    AutoEventWireup="true" CodeFile="InShort.aspx.cs" Inherits="Part_Inventory_InShort"
    Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>

<asp:Content ID="Content1" ContentPlaceHolderID="h" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="c" runat="Server">
    <div class="form" style="float: left; width: 450px">
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="cmdQuery" ValidationGroup="Query" runat="server" Text="Query" OnClick="cmdQuery_Click"
    ...
    <div class="help" style="float: right; width: 35%;">
        <ul>
            <li>
                <asp:Localize ID="lh1" runat="server" Text="Display lack quantity of part list when VMEP do quote." meta:resourcekey="lh1Resource1"></asp:Localize>
            </li>
            <%--<li>
                <asp:Localize ID="lh2" runat="server" Text="" meta:resourcekey="lh2Resource1"></asp:Localize>
            </li>
            <li>
                <asp:Localize ID="lh3" runat="server" Text=""
