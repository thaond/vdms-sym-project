<%@ Page Title="Inventory report" Language="C#" MasterPageFile="~/MP/Mobile.master" Theme="Mobile"
    AutoEventWireup="true" CodeFile="inventory.aspx.cs" Inherits="MPartReport_inventory" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
                ...
                <div class="form">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <vdms:DealerList AppendDataBoundItems="True" runat="server" ID="ddlDealers" ShowSelectAllItem="True" Width="80%"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnViewPartFromDealers" runat="server" Text="View" Width="40%" 
                ...
                <div class="form">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <vdms:DealerList AppendDataBoundItems="True" runat="server" ID="ddlDealers2" ShowSelectAllItem="False" Width="80%"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnViewPartsInDealer" runat="server" Text="View" Width="40%" 
