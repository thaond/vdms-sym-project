<%@ Page Language="C#" MasterPageFile="~/MP/Mobile.master" AutoEventWireup="true" CodeFile="CheckOrder.aspx.cs"
    Inherits="MSales_Inventory_CheckOrder" Title="Kiểm tra đơn hàng" Culture="auto" Theme="Mobile"
...
<asp:Content ID="Content2" ContentPlaceHolderID="c" runat="Server">
            ...
            <div class="form">
                ...
                <table>
                    <tr>
                        ...
                        <td valign="top">
                            ...
                            <asp:Localize ID="litTodate" runat="server" meta:resourcekey="litTodateResource1"
                                Text="~"></asp:Localize>
                            <asp:TextBox ID="txtToDate" runat="server" Width="40%" meta:resourcekey="txtToDateResource1">
                            </asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            <asp:TextBox ID="txtOrderNoFrom" runat="server" Width="40%" MaxLength="10" Style="text-transform: uppercase"
                                meta:resourcekey="txtOrderNo1Resource1"></asp:TextBox>
                            ~
                            <asp:TextBox ID="txtOrderNoTo" runat="server" Width="40%" MaxLength="10" Style="text-transform: uppercase"
                                meta:resourcekey="txtOrderNo1Resource1"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
    ...
    <asp:Button ID="btnSearch" runat="server" Text="Search" ValidationGroup="Search" Width="99%"
