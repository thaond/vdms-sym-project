<%@ Page Title="Inventory IO report" Language="C#" MasterPageFile="~/MP/Mobile.master" Theme="Mobile"
    AutoEventWireup="true" CodeFile="IOStockReport.aspx.cs" Inherits="MVehicle_Inventory_IOStockReport"
    ...
    <div class="form">
        <table>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtFromDate" runat="server" meta:resourcekey="txtFromDateResource1" Width="40%"></asp:TextBox>
                    ...
                    ~
                    <asp:TextBox ID="txtToDate" runat="server" meta:resourcekey="txtToDateResource1" Width="40%"></asp:TextBox>
                    <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender1" runat="server" TargetControlID="txtToDate"
                     ...
                     <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator1" runat="server" ControlToValidate="txtToDate"
                            Enabled="true" InvalidValueMessage="*" ControlExtender="MaskedEditExtender1"></ajaxToolkit:MaskedEditValidator>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnQuery" runat="server" Width="40%" Text="Query" OnClick="btnQuery_Click" meta:resourcekey="btnQueryResource1" />
