<%@ Page Title="Query bonus" Language="C#" MasterPageFile="~/MP/Mobile.master" AutoEventWireup="true" Theme="Mobile"
    CodeFile="Query.aspx.cs" Inherits="MBonus_Query" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <div class="form">
        <table width="100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtFrom" Width="40%" runat="server" meta:resourcekey="txtFromResource1"></asp:TextBox>
                    ...
                    <ajaxToolkit:MaskedEditValidator runat="server" ControlToValidate="txtFrom" Enabled="true" InvalidValueMessage="*" ControlExtender="txtFrom_MaskedEditExtender"></ajaxToolkit:MaskedEditValidator>
                    ~
                    <asp:TextBox ID="txtTo" Width="40%" runat="server" meta:resourcekey="txtToResource1"></asp:TextBox>
                    ...
                    <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator1" runat="server" ControlToValidate="txtTo" Enabled="true" InvalidValueMessage="*" ControlExtender="txtTo_MaskedEditExtender"></ajaxToolkit:MaskedEditValidator>
                </td>
            </tr>
            <tr>
                <td>
