...
// Code is generated on: 10/26/2010 12:38:01 AM
//
...
namespace VDMS.I.Entity
{
    ...
    public partial class ExchangePartDetail : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        public ExchangePartHeader ExchangePartHeader
        {
            ...
            set
            {
                ...
                if ((previousValue != value) || (this._ExchangePartHeader.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging();
        ...
        public Broken Broken
        {
            ...
            set
            {
                ...
                if ((previousValue != value) || (this._Broken.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging();
                    if (previousValue != null)
                    {
    ...
    public partial class ExchangePartHeader : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        public ServiceHeader ServiceHeader
        {
            ...
            set
            {
                ...
                if ((previousValue != value) || (this._ServiceHeader.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging();
                    if (previousValue != null)
                    {
        ...
        {
            this.SendPropertyChanging("ExchangePartDetails");
    ...
    public partial class ServiceHeader : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        {
            this.SendPropertyChanging("ExchangePartHeaders");
    ...
    public partial class Invoice : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        public DataIteminstance DataIteminstance
        {
            ...
            set
            {
                ...
                if ((previousValue != value) || (this._DataIteminstance.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging();
                    if (previousValue != null)
                    {
    ...
    public partial class DataIteminstance : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        public DataItem DataItem
        {
            ...
            set
            {
                ...
                if ((previousValue != value) || (this._DataItem.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging();
                    if (previousValue != null)
                    {
        ...
        {
            this.SendPropertyChanging("Invoices");
    ...
    public partial class DataItem : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        {
            this.SendPropertyChanging("DataIteminstances");
    ...
    public partial class WarrantyCondition : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        [Column(Name = @"REMARK", Storage = "_Remark", DbType = "VARCHAR2(512)")]
        ...
        [Column(Name = @"START_DATE", Storage = "_StartDate", DbType = "TIMESTAMP")]
        ...
        [Column(Name = @"STOP_DATE", Storage = "_StopDate", DbType = "TIMESTAMP")]
