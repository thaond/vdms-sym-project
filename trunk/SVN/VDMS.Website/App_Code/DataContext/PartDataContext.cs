...
namespace VDMS.II.Entity
{
    ...
    public partial class Dealer : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private int _AutoInStockPartSpan;

        private bool _AutoInStockPartStatus;

        private int _AutoInStockVehicleSpan;

        private bool _AutoInStockVehicleStatus;

        private DateTime _AutoInstockVehicleStartdate;
        ...
        partial void OnAutoInStockPartSpanChanging(int value);
        partial void OnAutoInStockPartSpanChanged();
        partial void OnAutoInStockPartStatusChanging(bool value);
        partial void OnAutoInStockPartStatusChanged();
        partial void OnAutoInStockVehiceSpanChanging(int value);
        partial void OnAutoInStockVehiceSpanChanged();
        partial void OnAutoInStockVehiceStatusChanging(bool value);
        partial void OnAutoInStockVehiceStatusChanged();
        partial void OnAutoinstockVehicleStartdateChanging(DateTime value);
        partial void OnAutoinstockVehicleStartdateChanged();
        #endregion
        ...
        [Column(Name = @"AUTOINSTOCK_PART_SPAN", Storage = "_AutoInStockPartSpan", CanBeNull = false, DbType = "NUMBER(6)")]
        public int AutoInStockPartSpan
        {
            get
            {
                return this._AutoInStockPartSpan;
            }
            set
            {
                if (this._AutoInStockPartSpan != value)
                {
                    this.OnAutoInStockPartSpanChanging(value);
                    this.SendPropertyChanging();
                    this._AutoInStockPartSpan = value;
                    this.SendPropertyChanged("AutoInStockPartSpan");
                    this.OnAutoInStockPartSpanChanged();
                }
            }
        }

        [Column(Name = @"AUTOINSTOCK_PART_STATUS", Storage = "_AutoInStockPartStatus", CanBeNull = false, DbType = "NUMBER(1)")]
        public bool AutoInStockPartStatus
        {
            get
            {
                return this._AutoInStockPartStatus;
            }
            set
            {
                if (this._AutoInStockPartStatus != value)
                {
                    this.OnAutoInStockPartStatusChanging(value);
                    this.SendPropertyChanging();
                    this._AutoInStockPartStatus = value;
                    this.SendPropertyChanged("AutoInStockPartStatus");
                    this.OnAutoInStockPartStatusChanged();
                }
            }
        }
        [Column(Name = @"AUTOINSTOCK_VEHICLE_SPAN", Storage = "_AutoInStockVehicleSpan", CanBeNull = false, DbType = "NUMBER(6)")]
        public int AutoInStockVehicleSpan
        {
            get
            {
                return this._AutoInStockVehicleSpan;
            }
            set
            {
                if (this._AutoInStockVehicleSpan != value)
                {
                    this.OnAutoInStockVehiceSpanChanging(value);
                    this.SendPropertyChanging();
                    this._AutoInStockVehicleSpan = value;
                    this.SendPropertyChanged("AutoInStockVehicleSpan");
                    this.OnAutoInStockVehiceSpanChanged();
                }
            }
        }

        [Column(Name = @"AUTOINSTOCK_VEHICLE_STATUS", Storage = "_AutoInStockVehicleStatus", CanBeNull = false, DbType = "NUMBER(1)")]
        public bool AutoInStockVehicleStatus
        {
            get
            {
                return this._AutoInStockVehicleStatus;
            }
            set
            {
                if (this._AutoInStockVehicleStatus != value)
                {
                    this.OnAutoInStockVehiceStatusChanging(value);
                    this.SendPropertyChanging();
                    this._AutoInStockVehicleStatus = value;
                    this.SendPropertyChanged("AutoInStockVehicleStatus");
                    this.OnAutoInStockVehiceStatusChanged();
                }
            }
        }
        [Column(Name = @"AUTOINSTOCK_VEHICLE_STARTDATE", Storage = "_AutoInstockVehicleStartdate", CanBeNull = false, DbType = "DATE NOT NULL")]
        public DateTime AutoinstockVehicleStartdate
        {
            get
            {
                return this._AutoInstockVehicleStartdate;
            }
            set
            {
                if (this._AutoInstockVehicleStartdate != value)
                {
                    this.OnAutoinstockVehicleStartdateChanging(value);
                    this.SendPropertyChanging();
                    this._AutoInstockVehicleStartdate = value;
                    this.SendPropertyChanged("AutoInstockVehicleStartdate");
                    this.OnAutoinstockVehicleStartdateChanged();
                }
            }
        }
