<%@ Page Language="C#" MasterPageFile="~/MP/MasterPage.master" AutoEventWireup="true"
    CodeFile="SaleDetail.aspx.cs" Inherits="Vehicle_Report_SaleDetail" Title="Báo cáo Sale - Chi tiết ngày"
    ...
    <div class="form">
            ...
            <tr>
                ...
                <td nowrap="nowrap" valign="middle">
                    ...
                    <asp:Button ID="btnExcel" runat="server" Text="Export to Excel" 
                        ValidationGroup="Search" onclick="btnExcel_Click" meta:resourcekey="btnExcelResource1" />
                </td>
            </tr>
            <tr>
                <td nowrap="nowrap" style="width: 46px">
        ...
        <div class="grid">
            <vdms:PageGridView AllowPaging="True" ID="gv" runat="server" AutoGenerateColumns="False"
                DataSourceID="ods" OnDataBinding="gv_DataBinding" PageSize="30" 
                EmptyDataText="No result found." meta:resourcekey="gvResource1">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="SellDate" 
                    ...
                    <asp:TemplateField HeaderText="TraTruoc" 
