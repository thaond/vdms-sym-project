<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CusInfInput2.aspx.cs" Inherits="Vehicle_Sale_CusInfInput2"
...
<body>
    ...
    function send_back_data()
    {
        ...
        var currCustomerIDnum = document.getElementById('txtCustomerID');
...
//	        alert(objCusFullnameEmpty.value);
	    ...
	    var currPhone = document.getElementById('txtCPhone'); 
	    if (currPhone.value != ""){
	    ...
	    var currMobile = document.getElementById('txtCMobile');
//	    if (currMobile.value == ""){
//	        //var objCusMobile = document.getElementById('CusMobile');
//	        //alert(objCusMobile.value);
//	        alert('<%= CusMobileEmpty %>');
//	        return false;
//	    }
	    ...
	    var currEmail = document.getElementById('txtCEmail');
//	    if (currEmail.value == ""){
					...
					<td>
						<table width="100%" border="0" cellspacing="4" cellpadding="0">
							...
							<tr id="Tr1">
								...
								<td align="left" style="width: 20%" valign="middle">
									<asp:Image ID="Image6" runat="server" SkinID="RequireFieldNon" meta:resourcekey="Image6Resource1" />
							...
							<tr id="item3"">
								...
								<td valign="middle">
									<asp:TextBox ID="txtCPhone" runat="server" CssClass="lblClass" MaxLength="10" meta:resourcekey="txtCPhoneResource1"></asp:TextBox>
								...
								<td valign="middle">
									<asp:TextBox ID="txtCMobile" runat="server" CssClass="lblClass" MaxLength="15" meta:resourcekey="txtCMobileResource1"></asp:TextBox>
							...
							<tr>
								<td align="left" style="width: 20%" valign="middle">
									<asp:Image ID="Image10" runat="server" SkinID="RequireFieldNon" meta:resourcekey="Image10Resource1" />
							...
							<tr valign="middle">
								<td colspan="4" align="right">
									<asp:Button ID="btnSave" runat="server" Text="Lưu" ValidationGroup="AddNewCustomer"
										OnClientClick="send_back_data();return false;" UseSubmitBehavior="False" CssClass="field_name"
